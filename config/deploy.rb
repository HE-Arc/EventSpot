...
set :application, "Eventspot"
set :repo_url, "https://github.com/HE-Arc/EventSpot.git"
set :branch, "main"
...
namespace :python do
	...
	# To Remove to exec migration and generate static files
	# execute "cd #{release_path}/eventspot && #{venv_path}/bin/python3 manage.py migrate"
